...
function predictImage() {
    ...
    // convert to balck and white image .. any color more than 177 is white i.e.255 and below 177 is black i.e 0
    cv.threshold(image, image, 177, 255, cv.THRESH_BINARY);
    // findimage boundary and crop image to rectangle
    ...
    // resize - to 20px image rectangle with 20px
    ...
    // add padding to make it 28x28 pxl image
    ...
    // find x and y coordinate of center of mass
    const cx = Moments.m10/Moments.m00;
    const cy = Moments.m10/Moments.m00;
    //console.log(Moments.m00 + '  ' + cx + ', ' +cy);
    
    // Sfiht the image to center of mass
